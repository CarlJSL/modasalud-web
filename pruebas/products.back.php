                                    ...
                                    <?php foreach ($products as $product): ?>
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-3 py-2 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="w-7 h-7 bg-gradient-to-br from-green-400 to-blue-500 rounded-full flex items-center justify-center mr-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-xs text-gray-500">
                                                            <?= !empty($product['size']) ? htmlspecialchars($product['size']) : 'Sin talla' ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
